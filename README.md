...
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/AutoFilterV4/Frwdit)


Deploy in your vps
```sh
git clone https://github.com/AutoFilterV4/Frwdit
cd Frwit
